...
def register():
    if request.method == "POST":
        ...
        register_dataframe.to_sql(name= 'register_page' , conn = engine, if_exists='append', index=False)
...
def login():
    if request.method == "POST":
        ...
        login_dataframe.to_sql(name= 'login_page' ,conn = engine, if_exists='append',  index=False)
